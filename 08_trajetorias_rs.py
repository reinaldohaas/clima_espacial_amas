...
def main():
    ap=argparse.ArgumentParser(); ap.add_argument("--teste",action="store_true"); ap.add_argument("--outdir",default="resultados")
    a=ap.parse_args(); os.makedirs(a.outdir,exist_ok=True)
    wind_nc=f"{a.outdir}/_era5_ventos_abrmai.nc"
    print("baixando/lendo ventos ERA5..."); baixa_ventos(wind_nc); ds=_open(wind_nc)
    # AOD para amostrar (opcional)
    aod=None
    cam=f"{a.outdir}/_cams_brasil_rs.nc"
