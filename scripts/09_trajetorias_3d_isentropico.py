...
def main():
    ...
    ap.add_argument("--teste",action="store_true"); ap.add_argument("--outdir",default="resultados"); ap.add_argument("--datadir",default="dados")
    a=ap.parse_args(); os.makedirs(a.outdir,exist_ok=True)
    nc=f"{a.datadir}/era5/_era5_uvwt_abrmai.nc"; print("baixando/lendo ERA5 (u,v,w,T)..."); baixa(nc); ds=_open(nc); dd=dims(ds)
    cfg=CFG[a.modo]
    if a.modo=="3d":
    ...
    aod=None; cam=f"{a.datadir}/cams/_cams_brasil_rs.nc"
